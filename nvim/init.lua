    ...
    -- Scroll
    {
      ...
      config = function()
        ...
        local keymap = {
          ...
          ["<leader>cu"] = function() neoscroll.zt({ half_win_duration = 250 }) end,
          ["<leader>cc"] = function() neoscroll.zz({ half_win_duration = 250 }) end,
          ["<leader>cb"] = function() neoscroll.zb({ half_win_duration = 250 }) end,
        }
        local modes = { 'n', 'v', 'x' }
